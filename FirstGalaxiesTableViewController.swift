//
//  FirstGalaxiesTableViewController.swift
//  SkeletonNASAApp2
//
...
class FirstGalaxiesTableViewController: UITableViewController {

    @IBOutlet weak var thisTableView: UITableView!
    
    var sections = SectionFirstGalaxies.fetchMyDetails()
...
extension FirstGalaxiesTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! FirstGalaxiesTableViewCell

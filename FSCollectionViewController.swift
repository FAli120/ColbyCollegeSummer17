//
//  FSCollectionViewController.swift
//  SkeletonNASAApp2
//
...
class FSCollectionViewController: UICollectionViewController {

    var myImagesArray = [FSImageViewer]()
    var name = String()
    override func viewDidLoad() {
        super.viewDidLoad()
        
        myImagesArray = FSImageViewer.fetchImages()
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! FSCollectionViewCell

//
//  DarkAgesTableViewController.swift
//  SkeletonNASAApp2
//
...
class DarkAgesTableViewController: UITableViewController {

    @IBOutlet weak var thisTableView: UITableView!
    
    var sections = SectionDarkAges.fetchMyDetails()
...
extension DarkAgesTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! DarkAgesTableViewCell

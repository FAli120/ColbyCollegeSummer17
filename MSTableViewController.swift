...
class MSTableViewController: UITableViewController {
    ...
    var sections = SectionMS.fetchMyDetails()
...
extension MSTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! MSTableViewCell

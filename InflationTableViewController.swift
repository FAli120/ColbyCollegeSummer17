//
//  InflationTableViewController.swift
//  SkeletonNASAApp2
//
...
class InflationTableViewController: UITableViewController {
    
    @IBOutlet weak var thisTableView: UITableView!
    
    var sections = SectionInflation.fetchMyDetails()
...
extension InflationTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! InflationTableViewCell
